...
REM
REM Generated by Vivado on Sat Jun 04 15:14:06 -0700 2022
...
echo "xvlog --incr --relax -prj Parametric_Testbench_vlog.prj"
call xvlog  --incr --relax -prj Parametric_Testbench_vlog.prj -log xvlog.log
