...
HD_PWD='C:/USV6/USV6.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Parametric_Top.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Parametric_Top.tcl
