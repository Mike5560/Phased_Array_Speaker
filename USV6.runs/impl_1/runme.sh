...
HD_PWD='C:/USV6/USV6.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Parametric_Top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Parametric_Top.tcl -notrace
